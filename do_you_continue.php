...
<div style="width: 35%;" class="log_panel">
	...
	<form action="" method="post">
		<input class="btn log_btn continue_yes" type="submit" name="yes" value="YES">
		<input class="btn log_btn continue_no" type="submit" name="no" value="NO - Start a new game">
	</form>
	<div class="under_log_btn">iT-Village, 2019</div>
</div>
...
if (isset($_POST['no'])) {
	$update_query = "UPDATE users SET in_progress = 'NO', last_money = NULL, remaining_moves = NULL, last_field = NULL WHERE username = '$username'";
