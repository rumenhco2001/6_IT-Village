		...
		if (isset($_POST['sign_up'])) {
			...
			if (!empty($username) && !empty($password)) {
				...
				if ($same_data != 0) {
					...
					$_SESSION['event'] = "<span style='font-size: 1.15vw;'><span class='green'>Welcome to iT-Village, $username!</span><br>&#8226; You always start the game with 50 coins and some random moves <span class='green'>($moves)</span><br>&#8226; Press the button to the right to throw the dice and read the text here to understand what it is going on, you will manage!</span>";
