...
if (isset($_POST['btn_new_game'])) {
	...
	$moves = rand(5, 10);
	$field = rand(1, 12);
	$_SESSION['event'] = "New game, <span class='underline green'>$moves moves and initial field $field</span>";
	$_SESSION['moves'] = $moves;
	$_SESSION['field'] = $field;
	$_SESSION['motels'] = 0;
	$_SESSION['vso_field'] = 0;

	$_SESSION['hide_btn_save'] = "false";
	$_SESSION['hide_btn_throw'] = "false";
...
if (isset($_POST['throw_dice'])) {
	...
	if ($_SESSION['money'] <= 0) {
		...
		$_SESSION['hide_btn_save'] = "true";
		$_SESSION['hide_btn_throw'] = "true";
...
<div class="nav">
	...
	<div class="nav_container">
		<form action="" method="post">
			<input style="<?php if(isset($_SESSION['hide_btn_save'])) { 
				if($_SESSION['hide_btn_save'] == "true") { echo 'visibility: hidden;'; } else { echo 'visibility: visible;'; } }?>" class="btn btn_save" type="submit" name="save" value="Save">
			<?php
			if (isset($_POST['save'])) {
...
<div class="dice_panel">
	<form action="" method="post">
		<input style="<?php if (isset($_SESSION['hide_btn_throw'])) { if ($_SESSION['hide_btn_throw'] == "true") { echo 'visibility: hidden;'; } else { echo 'visibility: visible;'; } }?>
		" class="btn btn-lignt btn_throw_dice" type="submit" name="throw_dice" value="THROW THE DICE">
	</form>
